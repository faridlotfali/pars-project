"""
Django settings for parspooyesh project.
...
SECRET_KEY = ')nrl)voyq-7u8)ic@5$$t!2pc%=ggypbw(q8oal4fs7!2&aaq7'
...
WSGI_APPLICATION = 'parspooyesh.wsgi.application'
