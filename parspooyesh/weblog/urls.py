...
urlpatterns = [
    url(r'^$',views.PostListView2.as_view(), name='index'),
    # url(r'^$',views.event, name='index'), 
    url(r'^posts/create/$',login_required(views.PostCreateView.as_view()), name='create'),
    url(r'^posts/(?P<slug>[\w-]+)/update/$',login_required(views.PostUpdateView.as_view()), name='update'),
